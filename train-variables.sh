# Set up variables
export BASE="${HOME}/case-study"
export BUCKET="gs://deepvariant"
export BIN_VERSION="0.5.1"
export MODEL_VERSION="0.5.0"
export MODEL_CL="182548131"
...
export MODEL="${MODELS_DIR}/model.ckpt-36555"
